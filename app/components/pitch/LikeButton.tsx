...
function LikeButton({username, pitchId}: Props) {
  ...
  return (
    <likeSubmit.Form method="post">
        ...
        <input type="hidden" value="like" name="vote"/>
<button className="btn btn-primary shadow-md shadow-base-100 " type="submit"><svg width="35" height="36" viewBox="0 0 35 36" fill="none" xmlns="http://www.w3.org/2000/svg">
